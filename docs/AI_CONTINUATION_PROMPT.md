...
当前最建议做的任务：
不要重复实现 CP6 第一批。优先从 CP6.1/CP6.2/CP6.3 中选一个继续：

可选方向：
1. CP6.1 NPC 原型接入：富少、小鱼、阿杰、柳如烟。
2. CP6.2 地点细分：图书馆楼层、惟学楼、博闻楼营业厅、韶华楼、知味/知雅餐厅。
3. CP6.3 周主题「开学迎新周」机制化，影响组织、事件或 NPC 行为。
