...
- 下一步扩展方向以“可扩展方向”表和 `docs/NEXT_AI_HANDOFF.md` 的 CP6.4/视觉复核建议为准。
...
| 深化周主题影响 | 第 1 周已影响事件、组织和 NPC；下一步重点补强第 4 周期末与体测周 |
| CP6.4 期末与体测周 | 让第 4 周主题进一步影响健康事件、操场/图书馆路线、体测压力和复习收益 |
| CP6 浏览器视觉复核 | 检查地图热点、开学周新增事件页、NPC 详情页移动端展示 |
