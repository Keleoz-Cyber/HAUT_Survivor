...
当前版本已完成 UI 2.0、周目标、成就称号、周总结、学业危机内容包、NPC 搭子系统、传闻/周主题机制化、探索奇遇链和 CP4.1 传闻类型补强。
...
- **NPC 搭子系统**：5 个校园 NPC，熟悉度、主动互动、本周搭子和互动结果
- **周目标与成就**：每周目标、经验/属性奖励、称号解锁
- **传闻/周主题机制**：传闻影响探索收益、NPC 遇见概率和事件倾向
